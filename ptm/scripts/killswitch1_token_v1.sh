...
export PTM_CKPT=/gfs/space/private/zjc/ptm/outputs/ptm_v1_full_contrast_detach_15k/checkpoints/epoch0_step15000.ckpt
export PTM_EVAL_LABEL=killswitch1_token_v1_15k
