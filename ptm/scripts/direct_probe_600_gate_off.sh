#!/bin/bash
set -e
PTM_CKPT="/gfs/space/private/zjc/ptm/outputs/ptm_gate_off_targetloss_10k/checkpoints/epoch0_step10000.ckpt"
PTM_EVAL_LABEL="direct_probe_600_gate_off_10000"
PTM_NUM_SHARDS=4
...
PTM_USE_PTM_CROSS_ATTENTION="false"
