...
/gfs/space/private/zjc/envs/worldmem/bin/python -m main \
  +name=ptm_gate_on_memattn_targetloss_10k \
  +output_dir=outputs/ptm_gate_on_memattn_targetloss_10k \
  ...
  ++algorithm.use_ptm_reference_adapter=true ++algorithm.use_memory_attention=true \
  ...
  ++algorithm.local_save_dir="outputs/ptm_gate_on_memattn_targetloss_10k" \
