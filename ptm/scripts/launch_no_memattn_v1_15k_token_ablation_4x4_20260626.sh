...
export PTM_CKPT="/gfs/space/private/zjc/ptm/outputs/ptm_v1_full_contrast_detach_no_memattn_15k_20260626_105120/checkpoints/epoch0_step15000.ckpt"
export PTM_EVAL_LABEL="ptm_v1_no_memattn_15k_token_ablation_4x4_20260626_1517"
...
echo "[validation] start no-memattn V1 15k token ablation 4x4 $(date -u +%Y-%m-%dT%H:%M:%SZ)"
