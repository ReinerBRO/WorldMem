...
/gfs/space/private/zjc/envs/worldmem/bin/python -m main \
  +name=ptm_v1_full_contrast_detach_15k \
  +output_dir=outputs/ptm_v1_full_contrast_detach_15k \
  ...
  ++algorithm.local_save_dir="outputs/ptm_v1_full_contrast_detach_15k" \
