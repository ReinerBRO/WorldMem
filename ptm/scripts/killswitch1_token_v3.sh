...
export PTM_CKPT=/gfs/space/private/zjc/ptm/outputs/ptm_v3_encoder_coupled_15k/checkpoints/epoch0_step15000.ckpt
export PTM_EVAL_LABEL=killswitch1_token_v3_15k
